...
var errorMap = []struct {
	...
	{domain.ErrMemberSuspended, http.StatusForbidden, "MEMBER_SUSPENDED",
		"This membership is suspended. Please speak to the library desk."},
	...
	{domain.ErrCopyNotFound, http.StatusNotFound, "COPY_NOT_FOUND",
		"We could not find that copy."},
	...
	{domain.ErrReservedForOther, http.StatusConflict, "RESERVED_FOR_ANOTHER_MEMBER",
		"That copy is reserved for another member."},
	{domain.ErrCopyNotBorrowable, http.StatusUnprocessableEntity, "COPY_NOT_BORROWABLE",
